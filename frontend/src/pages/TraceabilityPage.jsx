...
export default function TraceabilityPage() {
  ...
  const handleSelectiveExport = () => {
    ...
    try {
      ...
      const wsData = [
        [
          'Identifiant', translate('traceability.producer'), 'Parcelle', 
          'Date Récolte', 'Destination', 'Statut', 'TLC', 
          'Description Produit', 'GTIN', 'Lot Commercial', 
          'Pays Origine', 'Site Production', 'Date Production', 
          'Nom Expéditeur', 'Nom Destinataire', 'Date Expédition', 'Date Réception'
        ]
      ]
          ...
          <div>
            ...
            <div style={sec}>
              <h3 style={{color:'#1B2A4A',fontSize:'16px',fontWeight:'700',
                ...
                {translate('traceability.sectionA')}
              </h3>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'16px'}}>
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.recordId')}</label>
                  <div style={{padding:'10px 12px',background:'#F0F2F5',
                    borderRadius:'8px',fontSize:'13px',color:'#666',
                    border:'1px solid #ddd'}}>{translate('traceability.autoGenerated')}</div>
                </div>
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.creationDate')}</label>
                  <div style={{padding:'10px 12px',background:'#F0F2F5',
                    borderRadius:'8px',fontSize:'13px',color:'#666',
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.creatorUser')}</label>
                  <div style={{padding:'10px 12px',background:'#F0F2F5',
                    borderRadius:'8px',fontSize:'13px',color:'#666',
                    border:'1px solid #ddd'}}>
                    {localStorage.getItem('userEmail') || translate('traceability.connectedUser')}
                  </div>
                </div>
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.formVersion')}</label>
                  <div style={{padding:'10px 12px',background:'#F0F2F5',
                    borderRadius:'8px',fontSize:'13px',color:'#666',
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.initialStatus')}</label>
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>{translate('traceability.conformity')}</label>
            ...
            {/* B - Identification */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionB')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.tlc'),'traceabilityLotCode',form,setForm)}
                {fld(translate('traceability.productDesc'),'descriptionProduit',form,setForm)}
                {fld(translate('traceability.gtin'),'gtin',form,setForm)}
                {fld(translate('traceability.commercialLot'),'lotCommercial',form,setForm)}
                {fld(translate('traceability.sanitaryLot'),'lotSanitaire',form,setForm)}
                {fld(translate('traceability.quantity'),'quantite',form,setForm,'number')}
                {fld(translate('traceability.unit'),'uniteMesure',form,setForm,'text',['kg','box','pallet','unit'])}
              </div>
            </div>

            {/* C - Origine */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionC')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.originCountry'),'paysOrigine',form,setForm)}
                {fld(translate('traceability.productionSite'),'siteProductionNom',form,setForm)}
                {fld(translate('traceability.productionAddress'),'siteProductionAdresse',form,setForm)}
                {fld(translate('traceability.sanitaryApproval'),'numeroAgrementSanitaire',form,setForm)}
                {fld(translate('traceability.productionDate'),'dateProduction',form,setForm,'date')}
                {fld(translate('traceability.harvestDate'),'dateRecolte',form,setForm,'date')}
                {fld(translate('traceability.producer'),'producteur',form,setForm)}
                {fld(translate('traceability.plot'),'parcelle',form,setForm)}
                {fld(translate('traceability.treatments'),'traitements',form,setForm)}
              </div>
            </div>

            {/* D - Expédition */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionD')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.senderName'),'nomExpediteur',form,setForm)}
                {fld(translate('traceability.senderAddress'),'adresseExpediteur',form,setForm)}
                {fld(translate('traceability.senderGln'),'glnExpediteur',form,setForm)}
                {fld(translate('traceability.shipmentDate'),'dateExpedition',form,setForm,'datetime-local')}
                {fld(translate('traceability.transport'),'moyenTransport',form,setForm,'text',['Route','Mer','Air','Rail'])}
                {fld(translate('traceability.temperature'),'temperatureTransport',form,setForm,'number')}
              </div>
            </div>

            {/* E - Réception */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionE')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.recipientName'),'nomDestinataire',form,setForm)}
                {fld(translate('traceability.recipientAddress'),'adresseDestinataire',form,setForm)}
                {fld(translate('traceability.recipientGln'),'glnDestinataire',form,setForm)}
                {fld(translate('traceability.receptionDate'),'dateReception',form,setForm,'datetime-local')}
                {fld(translate('traceability.destination'),'destination',form,setForm)}
              </div>
            </div>

            {/* F - Import UE */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionF')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.euOperator'),'operateurUE',form,setForm)}
                {fld(translate('traceability.euAddress'),'adresseOperateurUE',form,setForm)}
                {fld(translate('traceability.eori'),'numeroEori',form,setForm)}
              </div>
            </div>

            {/* G - Documents */}
            <div style={sec}>
              <h3 style={secT}>{translate('traceability.sectionG')}</h3>
              <div style={grid2}>
                {fld(translate('traceability.docType'),'typeDocument',form,setForm,'text',['BOL','Invoice','CMR'])}
                {fld(translate('traceability.docNumber'),'numeroDocument',form,setForm)}
                {fld(translate('traceability.sanitaryCert'),'certificatSanitaire',form,setForm)}
                {fld(translate('traceability.lot'),'lot',form,setForm)}
              </div>
            </div>
            ...
            <div style={sec}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'16px'}}>
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>
                    {translate('traceability.glnCreator')}
                  </label>
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>
                    {translate('traceability.sourceSystem')}
                  </label>
                  <input style={{width:'100%',padding:'10px 12px',border:'1px solid #ddd',
                    borderRadius:'8px',fontSize:'14px',boxSizing:'border-box'}}
                    type="text"
            ...
            <div style={{...sec,border:'2px solid #C9A84C'}}>
              <h3 style={{color:'#1B2A4A',fontSize:'16px',fontWeight:'700',
                margin:'0 0 20px 0',paddingBottom:'10px',
                borderBottom:'2px solid #C9A84C'}}>
                {translate('traceability.sectionI')}
              </h3>
              ...
              <div style={{background:'#F8F9FA',borderRadius:'10px',padding:'20px',
                ...
                <div style={{display:'flex',alignItems:'flex-start',gap:'12px',
                  ...
                  <label htmlFor="donneesExactes" style={{fontSize:'14px',
                    ...
                    {translate('traceability.certifyText')}
                  </label>
                </div>
              </div>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'16px',
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>
                    {translate('traceability.responsibleSig')}
                  </label>
                  <input style={{width:'100%',padding:'10px 12px',border:'1px solid #ddd',
                    borderRadius:'8px',fontSize:'14px',boxSizing:'border-box'}}
                    type="text"
                ...
                <div>
                  <label style={{display:'block',marginBottom:'6px',fontWeight:'600',
                    color:'#1B2A4A',fontSize:'13px'}}>
                    {translate('traceability.validationDate')}
                  </label>
                  <input style={{width:'100%',padding:'10px 12px',border:'1px solid #ddd',
                    borderRadius:'8px',fontSize:'14px',boxSizing:'border-box'}}
                    type="datetime-local"
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'12px'}}>
                {[translate('traceability.draft'),translate('traceability.validated'),translate('traceability.locked')].map(s=>(
                  <div key={s}
            ...
            <div style={{...sec,border:'2px solid #28a745'}}>
              <h3 style={{color:'#1B2A4A',fontSize:'16px',fontWeight:'700',
                ...
                {translate('traceability.sectionJ')}
              </h3>

              <div style={grid2}>
                {/* Zone d'import du document principal */}
                <div>
                  <label style={lbl}>{translate('traceability.mainDoc')}</label>
                    ...
                    {documentPreview ? (
                      ...
                      <div>
                        ...
                        <div style={{fontSize:'14px',color:'#666'}}>
                          {translate('traceability.dropFile')}
                        </div>
                ...
                <div>
                  <label style={lbl}>{translate('traceability.scannedSig')}</label>
                  <div style={{marginBottom:'8px',fontSize:'12px',color:'#666'}}>
                  ...
                  >
                    ...
                    {signaturePreview ? (
                      ...
                      <div>
                        ...
                        <div style={{fontSize:'14px',color:'#666'}}>
                          {translate('traceability.dropSig')}
                        </div>
                        <div style={{fontSize:'12px',color:'#999',marginTop:'4px'}}>
                          ou cliquez pour choisir
                        </div>
            ...
            <div style={sec}>
              ...
              <div style={{marginTop:'16px',display:'flex',gap:'12px',alignItems:'center'}}>
                ...
                <button 
                  ...
                  <Download size={16} />
                  {translate('traceability.exportSelection')} ({selectedRecords.size})
                </button>
              </div>
            </div>
